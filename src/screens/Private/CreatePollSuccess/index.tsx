...
export default function CreatePollSuccess() {
  ...
  const handleCreateAnotherPoll = useCallback(() => {
    router.back();
  }, []);
      ...
      >
        ...
        <Box style={[globalStyles.columnCenter, { gap: 16 }]}>
          ...
          <Typography
            ...
            paddingBottom={32}
          >
            This poll is now live and notifications have been sent to every
          ...
          <Button
            title="Create another poll"
            outlined
            containerStyle={{ alignSelf: 'stretch' }}
            onPress={handleCreateAnotherPoll}
          />
        </Box>
      </ScrollView>
    </SafeScreenView>
